package bio.terra.soundchecktest.api;
...
import bio.terra.soundchecktest.config.VersionConfiguration;
import bio.terra.soundchecktest.controller.PublicApiController;
import bio.terra.soundchecktest.model.SystemStatus;
import bio.terra.soundchecktest.service.StatusService;
...
class PublicApiControllerTest {
  ...
  void testVersion() throws Exception {
    ...
    String github = "https://github.com/DataBiosphere/mf-soundcheck-testing/tree/0.9.0";
    String build = "0.1.0";
