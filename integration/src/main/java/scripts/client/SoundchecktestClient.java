...
import bio.terra.soundchecktest.client.ApiClient;
...
public class SoundchecktestClient extends ApiClient {
   ...
   */
  public SoundchecktestClient(ServerSpecification server) throws IOException {
    this(server, null);
  }
   ...
   */
  public SoundchecktestClient(ServerSpecification server, TestUserSpecification testUser)
      throws IOException {
